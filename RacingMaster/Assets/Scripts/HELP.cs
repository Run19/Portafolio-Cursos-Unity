...
public class HELP : MonoBehaviour
{
    ...
    public void CreaCalles()
    {
        ...
        GameObject Calle = (GameObject)Instantiate(contenedorCalles[numSelectorDeCalle], new Vector3(0, 50, 0), transform.rotation);
        ...
        Calle.transform.position = new Vector3(transform.position.x, piezaAux.GetComponent<Renderer>().
            bounds.size.y + piezaAux.transform.position.y, piezaAux.transform.position.z);
    }
